package com.mac.rest.restfulwebservices.exception;
...
import com.mac.rest.restfulwebservices.users.UserNotFoundException;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler{
	 ...
	 * status, WebRequest request) { ErrorDetails errorDetails = new
	 * ErrorDetails(LocalDateTime.now(), "Total Errors:" + ex.getErrorCount() +
